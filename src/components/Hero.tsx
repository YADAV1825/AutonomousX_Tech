...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-[92vh] flex items-center overflow-hidden" id="hero">
      ...
      <div className="absolute top-20 right-20 w-72 h-72 rounded-full bg-gradient-to-br from-soft-red/10 to-sky/10 blur-3xl animate-pulse pointer-events-none" />
      <div className="absolute bottom-20 left-10 w-96 h-96 rounded-full bg-gradient-to-br from-ice/20 to-lavender/10 blur-3xl animate-pulse pointer-events-none" style={{ animationDelay: "1s" }} />
      ...
      {/* Content */}
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-32 flex w-full">
        <motion.div
        ...
        >
          ...
          >
            <Link href="#contact" className="btn-gradient text-base no-underline">
              Book a Demo
            </Link>
            <Link href="#curriculum-timeline" className="btn-outline text-base no-underline">
              Explore Curriculum
            </Link>
          </motion.div>
